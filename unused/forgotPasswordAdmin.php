	...
	<div class="container-fluid mx-auto">
		<div class="row">
			<div class="col-sm-12 text-black">
				...
				<form style="width: 23rem;" method = "POST" action = "adminDoForgot.php" class = "">

					<h3 class="fw-normal mt-3 d-flex justify-content-center" style="letter-spacing: 0.5px; font-style:italic; font-size:38px;">
						Cargo Master<br>
						<h4 class = "d-flex justify-content-center" style="font-style: italic;">Admin Forgot Password</h4>
                    ...
                    <div class="form-outline mb-4">
						...
						<input type="password" id="form2Example48" class="form-control form-control-lg" name = "newPasswordADM" required />
					</div>

                    <div class="form-outline mb-4">
						<label class="form-label" for="form2Example58">Confirm New Password</label>
						<input type="password" id="form2Example58" class="form-control form-control-lg" name = "newPasswordConfirmADM" required/>
					</div>

					<div class="pt-1 mb-4">
						<button class="btn btn-info btn-lg btn-block" type="submit" name = "change" >Change Password</button>
					</div>
